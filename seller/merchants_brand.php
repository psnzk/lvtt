...
function get_brandlist($ru_id)
{
	...
	while ($rows = $GLOBALS['db']->fetchRow($res)) {
		...
		$brand_logo = (empty($rows['brandLogo']) ? '' : '<a href="../' . $rows['brandLogo'] . '" target="_brank"><img src="images/picflag.gif" width="16" height="16" border="0" alt=' . $GLOBALS['_LANG']['brand_logo'] . ' /></a>');
		$site_url = (empty($rows['site_url']) ? 'N/A' : '<a href="' . $rows['site_url'] . '" target="_brank">' . $rows['site_url'] . '</a>');

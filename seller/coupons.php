...
if ($_REQUEST['act'] == 'update') {
	...
	$sql = 'UPDATE ' . $ecs->table('coupons') . ' SET ' . 'cou_name       = \'' . $_POST['cou_name'] . '\', ' . 'cou_title       = \'' . $_POST['cou_title'] . '\', ' . 'cou_total       = \'' . $_POST['cou_total'] . '\', ' . 'cou_man       = \'' . $_POST['cou_man'] . '\', ' . 'cou_money       = \'' . $_POST['cou_money'] . '\', ' . 'cou_user_num       = \'' . $cou_user_num . '\', ' . 'cou_goods       = \'' . $cou_goods . '\', ' . 'cou_start_time       = \'' . $cou_start_time . '\', ' . 'cou_end_time       = \'' . $cou_end_time . '\', ' . 'cou_type       = \'' . $_POST['cou_type'] . '\', ' . 'cou_get_man       = \'' . $_POST['cou_get_man'] . '\', ' . 'cou_ok_user       = \'' . $cou_ok_user . '\', ' . 'cou_ok_goods       = \'' . $cou_ok_goods . '\', ' . 'cou_intro       = \'' . $_POST['cou_intro'] . '\', ' . 'cou_add_time       = \'' . $cou_add_time . '\' ' . 'WHERE cou_id   = \'' . $cou_id . '\'';
	$db->query($sql);
	clear_cache_files();
	$link[0]['text'] = $_LANG['back_list'];
	$link[0]['href'] = 'coupons.php?act=list';

                ...
                <div class="brand_select_more">
                  <div class="all_a_z">
                      <ul class="a_z">
                          ...
                          <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'letter_0_92395400_1483518331');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['letter_0_92395400_1483518331']):
?>
                            <li data-key="<?php echo $this->_var['letter_0_92395400_1483518331']; ?>"><?php echo $this->_var['letter_0_92395400_1483518331']; ?></li>
                          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
            <li class="same_li">
              <dl class="attr_list">
                <div class="filter_attr_name"><?php echo htmlspecialchars($this->_var['filter_attr']['filter_attr_name']); ?>：</div>
                <div class="attr_son">
                  <div class="item_list">

<div class="item <?php echo $this->_var['var']['code']; ?>"  data-val="<?php echo $this->_var['var']['id']; ?>">
    ...
    <div class="label_value"><input type="text" name="value[<?php echo $this->_var['var']['id']; ?>]" class="text <?php echo $this->_var['var']['code']; ?>" value="<?php echo $this->_var['var']['value']; ?>" autocomplete="off"  /><?php if ($this->_var['var']['desc']): ?><div class="notic"><?php echo nl2br($this->_var['var']['desc']); ?></div><?php endif; ?></div>
    <?php elseif ($this->_var['var']['type'] == "password"): ?>
    <div class="label_value"><input type="password" name="value[<?php echo $this->_var['var']['id']; ?>]" class="text" value="<?php echo $this->_var['var']['value']; ?>" autocomplete="off" /><?php if ($this->_var['var']['desc']): ?><div class="notic"><?php echo nl2br($this->_var['var']['desc']); ?></div><?php endif; ?></div>
    <?php elseif ($this->_var['var']['type'] == "textarea"): ?>
    <div class="label_value"><textarea class="textarea" name="value[<?php echo $this->_var['var']['id']; ?>]" id="role_describe"><?php echo $this->_var['var']['value']; ?></textarea><?php if ($this->_var['var']['desc']): ?><div class="notic"><?php echo nl2br($this->_var['var']['desc']); ?></div><?php endif; ?></div>
...
?>
              <?php if ($this->_var['region']['region_id'] == $this->_var['cfg']['shop_country']): ?><?php echo $this->_var['region']['region_name']; ?><?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <input type="hidden" name="value[<?php echo $this->_var['var']['id']; ?>]" value="<?php echo $this->_var['cfg']['shop_country']; ?>"/>

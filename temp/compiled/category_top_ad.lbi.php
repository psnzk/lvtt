...
?>
	<div <?php if ($this->_var['key'] % 2): ?>class="left"<?php else: ?>class="right"<?php endif; ?>><a href="<?php echo $this->_var['ad']['ad_link']; ?>" target="_blank"><img src="themes/<?php echo $GLOBALS['_CFG']['template']; ?>/images/loadGoods2.gif" style="max-width:<?php echo $this->_var['ad']['ad_width']; ?>px; max-height:<?php echo $this->_var['ad']['ad_height']; ?>px;" class="lazy" data-original="<?php echo $this->_var['ad']['ad_code']; ?>"/></a></div>

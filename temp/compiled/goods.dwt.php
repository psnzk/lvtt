...
?>  
                                        <li class="item<?php if ($this->_var['value']['checked'] == 1 && $this->_var['cfg']['add_shop_price'] == 1): ?> selected<?php endif; ?>">
                                            ...
                                            <a rev="<?php echo $this->_var['value']['img_site']; ?>" name="<?php echo $this->_var['value']['id']; ?>" href="javascript:;" onclick="get_url(this)" >
                                                ...
                                                <?php echo $this->_var['value']['label']; ?>
                                                <?php endif; ?>
                                                <input style="display:none" id="spec_value_<?php echo $this->_var['value']['id']; ?>" type="<?php if ($this->_var['spec']['attr_type'] == 2): ?>checkbox<?php else: ?>radio<?php endif; ?>" data-attrtype="<?php if ($this->_var['spec']['attr_type'] == 2): ?>2<?php else: ?>1<?php endif; ?>" name="spec_<?php echo $this->_var['spec_key']; ?>" value="<?php echo $this->_var['value']['id']; ?>" />
...
?>  
                                                <li class="item<?php if ($this->_var['key'] == 0 && $this->_var['cfg']['add_shop_price'] == 1): ?> selected<?php endif; ?>">
                                                    ...
                                                    <a href="javascript:;" name="<?php echo $this->_var['value']['id']; ?>" class="noimg">
                                                        <?php echo $this->_var['value']['label']; ?>
                                                        <input style="display:none" id="spec_value_<?php echo $this->_var['value']['id']; ?>" type="<?php if ($this->_var['spec']['attr_type'] == 2): ?>checkbox<?php else: ?>radio<?php endif; ?>" data-attrtype="<?php if ($this->_var['spec']['attr_type'] == 2): ?>2<?php else: ?>1<?php endif; ?>" name="spec_<?php echo $this->_var['spec_key']; ?>" value="<?php echo $this->_var['value']['id']; ?>" /></a> 
...
?>
                            ...
                            <div class="choose-num choose-xznum li">
                                ...
                                <div class="dd">
                                    ...
                                    <input class="text buy-num" id="quantity" onblur="changePrice()" value="<?php if ($this->_var['goods']['measure_unit'] == 0): ?>0<?php else: ?>1<?php endif; ?>" name="number" defaultnumber="1">
...
?>
                    <dl class="<?php if ($this->_var['key'] == 0): ?>open<?php endif; ?>">
                        <dt><s class="icon"></s><a href="<?php echo $this->_var['cat']['url']; ?>" target="_blank"><span class="cate_name"><?php echo $this->_var['cat']['name']; ?></span></a></dt>
...
$(function(){
	...
	<?php if ($this->_var['cfg']['add_shop_price'] == 0): ?>
		$(".goods_info_attr").find("li.item :input").prop("checked", false);
		$(".goods_info_attr").find("li.item").removeClass("selected");
	<?php endif; ?>
});

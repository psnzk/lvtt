            ...
            <div class="ecsc-login-container">
                ...
                <div class="login-right">
                    ...
                    <div class="items">
                        ...
                        <div class="item">
                        	<input type="text" name="captcha" id="captcha" autocomplete="off" class="text" style="width: 80px;" maxlength="4" size="10" placeholder="<?php echo $this->_var['lang']['label_captcha']; ?>">
                        	<div class="code">

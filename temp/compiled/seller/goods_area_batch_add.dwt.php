				...
				<table width="100%" class="table_item">
				  ...
				  <tr>
					...
					<td class="pt5">
						...
						<p id="noticeFile" class="red bf100 fl"><?php echo $this->_var['lang']['notice_file']; ?></p>
					</td>
				  </tr>
...
?>
				  ...
				  <tr>
					<td>&nbsp;</td>
					<td><a href="goods_area_batch.php?act=download&charset=<?php echo $this->_var['charset']; ?>&goods_id=<?php echo $this->_var['goods_id']; ?>" class="blue"><?php echo $this->_var['download']; ?></a></td>
				  </tr>
				  <?php endif; ?>

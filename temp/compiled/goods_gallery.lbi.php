    ...
    <div class="spec-list">
        ...
        <div class="spec-items">
            <ul>
                ...
                <li><a href="<?php echo $this->_var['goods']['goods_img']; ?>" rel="zoom-id: Zoomer" rev="<?php echo $this->_var['goods']['goods_img']; ?>"><img src="themes/<?php echo $GLOBALS['_CFG']['template']; ?>/images/loadGoods.gif" alt="<?php echo $this->_var['goods']['goods_name']; ?>" width="60" height="60" class="lazy" data-original="<?php echo $this->_var['goods']['goods_img']; ?>"/></a></li>
                <?php endif; ?>

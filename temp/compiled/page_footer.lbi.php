...
?>
                <dd><a href="<?php echo $this->_var['item']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['item']['title']); ?>" target="_blank"><i>&gt;</i><?php echo $this->_var['item']['short_title']; ?></a></dd>
            ...
            <div class="QR_code">
                ...
                <div class="code_warp">
                    ...
                    <div class="code_tp hide"><img src="<?php echo $this->_var['site_domain']; ?><?php echo $this->_var['ectouch_qrcode']; ?>"></div>
                </div>
            </div>
        </div>
        <div class="footer-desc-copyright">
            ...
            <p class="footer-ecscinfo">
            	<?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_55506200_1483498018');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_55506200_1483498018']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
            	<a href="<?php echo $this->_var['nav_0_55506200_1483498018']['url']; ?>" <?php if ($this->_var['nav_0_55506200_1483498018']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_55506200_1483498018']['name']; ?></a> 

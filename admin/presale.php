...
if ($_REQUEST['act'] == 'list') {
	...
	if (($_REQUEST['act'] == 'add') || ($_REQUEST['act'] == 'edit')) {
		if ($_REQUEST['act'] == 'add') {
			$presale = array('cat_id' => 0, 'start_time' => date('Y-m-d H:i:s', time() + 86400), 'end_time' => date('Y-m-d H:i:s', time() + (4 * 86400)), 'pay_start_time' => date('Y-m-d H:i:s', time() + (4 * 86400) + 1), 'pay_end_time' => date('Y-m-d H:i:s', time() + (6 * 86400)));

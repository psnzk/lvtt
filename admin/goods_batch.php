...
if ($_REQUEST['act'] == 'add') {
	...
	@closedir($dir);
	$data_format_array = array('ecshop' => $_LANG['export_ecshop'], 'taobao' => $_LANG['export_taobao'], 'paipai' => $_LANG['export_paipai'], 'paipai3' => $_LANG['export_paipai3'], 'taobao46' => $_LANG['export_taobao46']);

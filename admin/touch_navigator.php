...
if ($_REQUEST['act'] == 'list') {
	...
	if (empty($_REQUEST['step'])) {
		...
		if ($arr) {
			...
			$sql = 'UPDATE ' . $GLOBALS['ecs']->table('touch_nav') . ' SET name=\'' . $item_name . '\',ctype=\'' . $arr['type'] . '\',cid=\'' . $arr['id'] . '\',ifshow=\'' . $item_ifshow . '\',vieworder=\'' . $item_vieworder . '\',opennew=\'' . $item_opennew . '\',url=\'' . $item_url . '\',type=\'' . $item_type . '\',pic=\'' . $pic . '\'  WHERE id=\'' . $id . '\'';
		}
		else {
			...
			$sql = 'UPDATE ' . $GLOBALS['ecs']->table('touch_nav') . ' SET name=\'' . $item_name . '\',ctype=\'\',cid=\'\',ifshow=\'' . $item_ifshow . '\',vieworder=\'' . $item_vieworder . '\',opennew=\'' . $item_opennew . '\',url=\'' . $item_url . '\',type=\'' . $item_type . '\',pic=\'' . $pic . '\'  WHERE id=\'' . $id . '\'';
		}

...
if ($_REQUEST['act'] == 'list') {
	...
	$smarty->assign('ur_here', $_LANG['users_real_list']);
	...
	$post_user_real = array('user_id' => $user_id, 'real_name' => $real_name, 'self_num' => $self_num, 'review_status' => $review_status, 'review_content' => $review_content, 'bank_card' => $bank_card);
	$type = '';

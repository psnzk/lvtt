...
{
  $.get(ROOT_URL + 'index.php?m=crowd_funding&c=index&a=Shippingfee', {shipping: obj}, function(data){
...
function selectPayment(value)
{
  ...
  $.get(ROOT_URL + 'index.php?m=flow&c=index&a=select_payment', {payment:value,shipping_id:arr}, function(data){
...
function selectPack(value)
{
  ...
  $.get(ROOT_URL + 'index.php?m=flow&c=index&a=select_pack', {pack:value}, function(data){
    orderSelectedResponse(data);
  }, 'json');
}
...
function changeIntegral(val)
{
 ...
 else
 {
  ...
  $.get(ROOT_URL + 'index.php?m=flow&c=index&a=change_integral', {points: val,shipping_id:arr}, function(data){
...
function changeNeedInv()
{
  ...
  $.get(ROOT_URL + 'index.php?m=flow&c=index&a=change_needinv', {need_inv:needInv, inv_type:encodeURIComponent(invType), inv_payee:encodeURIComponent(invPayee), inv_content:encodeURIComponent(invContent)}, function(data){
    orderSelectedResponse(data);
  });
...
var ECS_INTEGRAL = '';
  ...
  if (document.getElementById("ECS_SURPLUS"))
  {
    ...
    var info = $.ajax({
                  url : ROOT_URL + 'index.php?m=flow&c=index&a=check_surplus',
                  async : false,
  ...
  if (document.getElementById("ECS_INTEGRAL"))
  {
    ...
    var info = $.ajax({
                  url : ROOT_URL + 'index.php?m=flow&c=index&a=check_integral',
                  async : false,

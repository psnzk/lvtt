...
class Index extends \app\http\base\controllers\Frontend
{
	...
	public function actionDetail()
	{
		...
		$goods_list = brand_get_goods($brand_id, $mbid, $cate, $this->size, $this->page, $this->sort, $this->order, $this->region_id, $this->area_id, '', $this->is_ship, $this->price_min, $this->price_max, $this->$type);
		$new_count = goods_count_by_brand($brand_id, $mbid, $cate, $act, $ship, $price_min, $price_max, $region_id, $this->area_id, $this->self, 'new');
		$hot_count = goods_count_by_brand($brand_id, $mbid, $cate, $act, $ship, $price_min, $price_max, $region_id, $this->area_id, $this->self, 'hot');
		$promote_count = goods_count_by_brand($brand_id, $mbid, $cate, $act, $ship, $price_min, $price_max, $region_id, $this->area_id, $this->self, 'promote');
		$best_count = goods_count_by_brand($brand_id, $mbid, $cate, $act, $ship, $price_min, $price_max, $region_id, $this->area_id, $this->self, 'best');
	...
	public function actionGoods()
	{
		if (IS_AJAX) {
			...
			$act = '';
			$size = 10;
			$goods_list = brand_get_goods_ajax($brand_id, $this->mbid, $cate, $size, $page, $this->sort, $this->order, $this->region_id, $this->area_id, $act, $this->is_ship, $this->price_min, $this->price_max, $this->$type);

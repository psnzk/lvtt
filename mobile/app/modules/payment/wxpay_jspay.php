...
class wxpay_jspay
{
	...
	function get_code($order, $payment)
	{
		...
		$html = '<div style="text-align:center"><button class="btn btn-primary box-flex btn-submit" type="button" onclick="javascript:alert(\'请在微信客户端打开链接\')">微信安全支付</button></div>';
        ...
        if( empty($error) )
        {
			...
			$html = '<div style="text-align:center"><button class="btn btn-primary box-flex btn-submit" type="button" onclick="callpay()">微信安全支付</button></div>'.$js;
        }else{
			$html = '<div style="text-align:center"><button class="btn btn-primary box-flex btn-submit" type="button" onclick="javascript:alert(\''. $error .'\')">微信安全支付</button></div>';
		}

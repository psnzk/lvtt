...
class NormalizerFormatterTest extends \PHPUnit_Framework_TestCase
{
	...
	'context'    => array('foo' => 'bar', 'baz' => 'qux', 'inf' => INF, '-inf' => 0 - INF, 'nan' => acos(4))
	));
	...
	'context'    => array('foo' => 'bar', 'baz' => 'qux', 'inf' => 'INF', '-inf' => '-INF', 'nan' => 'NaN')
	), $formatted);
	}
	...
	public function testFormatExceptions()
	{
		...
		unset($formatted['exception']['previous']);
		$this->assertEquals(array(
	'exception' => array('class' => get_class($e2), 'message' => $e2->getMessage(), 'code' => $e2->getCode(), 'file' => $e2->getFile() . ':' . $e2->getLine())
	), $formatted);
	}
	...
	public function testFormatSoapFaultException()
	{
		...
		unset($formatted['exception']['trace']);
		$this->assertEquals(array(
	'exception' => array('class' => 'SoapFault', 'message' => 'bar', 'code' => 0, 'file' => $e->getFile() . ':' . $e->getLine(), 'faultcode' => 'foo', 'faultactor' => 'hello', 'detail' => 'world')
	), $formatted);
	}
	...
	public function testConvertsInvalidEncodingAsLatin9()
	{
		...
		if (version_compare(PHP_VERSION, '5.5.0', '>=')) {
			$this->assertSame('{"message":"€ŠšŽžŒœ�?}', $res);
		}
		else {
	...
	'latin9 string'  => array("\xb11\xa4\xa6\xa8\xb4\xb8\xbc\xbd\xbe\xff", '±1€ŠšŽžŒœŸ�?),
	'unicode string' => array('¤¦¨´¸¼½¾€ŠšŽžŒœ�?, '¤¦¨´¸¼½¾€ŠšŽžŒœ�?),
	'empty array'    => array(
		array(),
		array()
		),

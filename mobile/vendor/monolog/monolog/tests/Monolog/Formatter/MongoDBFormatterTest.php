...
class MongoDBFormatterTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testSimpleFormat()
	{
		...
		$this->assertEquals(\Monolog\Logger::WARNING, $formattedRecord['level']);
		$this->assertEquals(\Monolog\Logger::getLevelName(\Monolog\Logger::WARNING), $formattedRecord['level_name']);
	...
	public function testRecursiveFormat()
	{
		...
		$record = array(
			'message'    => 'some log message',
			'context'    => array('stuff' => new \DateTime('2014-02-01 02:31:33'), 'some_object' => $someObject, 'context_string' => 'some string', 'context_int' => 123456, 'except' => new \Exception('exception message', 987)),
			'level'      => \Monolog\Logger::WARNING,
			'level_name' => \Monolog\Logger::getLevelName(\Monolog\Logger::WARNING),
			'channel'    => 'test',
			'datetime'   => new \DateTime('2014-02-01 00:00:00'),
	...
	public function testFormatDepthArray()
	{
		$record = array(
			...
			'context'    => array(
				'nest2' => array(
					'property' => 'anything',
					'nest3'    => array('nest4' => 'value', 'property' => 'nothing')
					)
				),
			'level'      => \Monolog\Logger::WARNING,
			'level_name' => \Monolog\Logger::getLevelName(\Monolog\Logger::WARNING),
	...
	'nest2' => array('property' => 'anything', 'nest3' => '[...]')
	...
	public function testFormatDepthObjects()
	{
		...
		$record = array(
			'message'    => 'some log message',
			'context'    => array('nest2' => $someObject),
			'level'      => \Monolog\Logger::WARNING,
			'level_name' => \Monolog\Logger::getLevelName(\Monolog\Logger::WARNING),
			'channel'    => 'test',
			'datetime'   => new \DateTime('2014-02-01 00:00:00'),
		...
		$formattedResult = $formatter->format($record);
		$this->assertEquals(array(
	'nest2' => array('property' => 'anything', 'nest3' => '[...]', 'class' => 'stdClass')
	), $formattedResult['context']);
	}
	...
	public function testFormatDepthException()
	{
		$record = array(
			'message'    => 'some log message',
			'context'    => array('nest2' => new \Exception('exception message', 987)),
			'level'      => \Monolog\Logger::WARNING,
			'level_name' => \Monolog\Logger::getLevelName(\Monolog\Logger::WARNING),
			'channel'    => 'test',
			'datetime'   => new \DateTime('2014-02-01 00:00:00'),

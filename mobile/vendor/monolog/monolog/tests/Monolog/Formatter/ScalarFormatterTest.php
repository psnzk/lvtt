...
class ScalarFormatterTest extends \PHPUnit_Framework_TestCase
{
	...
	'context' => array('exception' => $exception)
		...
		$this->assertSame(array('context' => $this->encodeJson(array(
	'exception' => array('class' => get_class($exception), 'message' => $exception->getMessage(), 'code' => $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine(), 'trace' => $this->buildTrace($exception))
	))), $formatted);
	}
}

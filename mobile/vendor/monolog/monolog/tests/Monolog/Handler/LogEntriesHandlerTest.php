...
class LogEntriesHandlerTest extends \Monolog\TestCase
{
	/**
     * @var resource
     */
	...
	{
		$this->createHandler();
		$this->handler->handle($this->getRecord(\Monolog\Logger::CRITICAL, 'Critical write test'));
		fseek($this->res, 0);
	...
	private function createHandler()
	{
		...
		$args = array('testToken', $useSSL, \Monolog\Logger::DEBUG, true);

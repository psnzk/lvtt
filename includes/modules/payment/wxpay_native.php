...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 网址 */
    $modules[$i]['website'] = 'http://z1988.com';
...
class wxpay_native
{
	...
	function get_code($order, $payment)
	{
        ...
        if($url2 != NULL)
        {
            ...
            $html = '<div id="paymentDiv"><div style="text-align:center" id="qrcode"><p>微信扫描，立即支付</p><div>'. $img .'</div></div><div id="wxPhone"></div></div>';
			...
			$html .='<script type="text/javascript">
				function get_wxpay_native_status( id ){
					...
					*/
					Ajax.call("wxpay_native_query.php", "id="+id, return_wxpay_order_status, "GET", "JSON");
